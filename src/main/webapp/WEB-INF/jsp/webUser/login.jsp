...
<div class="card border border-light-subtle rounded-3 shadow-sm login-card">
  <div class="row g-0">
    ...
    <div class="col-md-6 login-form-side p-4">
      <div class="card-body">
        ...
        <form action="/login/process" method="post">
          ...
          <p class="text-secondary text-center">Don't have an account? <a href="/sign-up" class="link-primary">Sign up</a></p>
        </form>
      </div>
    </div>
    ...
    <div class="col-md-6 login-icon-side d-flex flex-column justify-content-center align-items-center p-4 bg-light">
      <img class="login-icon" src="/resources/admin/image/login-icon.jpg" alt="Logo">
      ...
      <p class="text-center mb-4">Welcome! Please log in to access your dashboard and view your profile.Don't have an account? <a href="/sign-up" class="link-primary text-decoration-none">Sign Up</a></p>
    </div>
  </div>
</div>
</div>
